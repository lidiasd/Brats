...
Pendant l'entraînement, nous utilisons un learning rate   de 0.001 sur 15 époques, avec des images de taille 128x128 et un batch size de 2. Les métriques évaluées comprennent MeanIoU (pour quatre classes), dice_coef, précision, sensibilité, spécificité, et à nouveau dice_coef pour assurer une évaluation globale complète.
